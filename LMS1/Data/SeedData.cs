    ...
    public class SeedData
    {
        ...
        private static List<Course> CreateCourses()
        {
            ...
            var title = new string[]
                { "C01", "C02" };
            var startDate = new System.DateTime[]
                { System.DateTime.Today, DateTime.Today.AddDays(3) };
            var endDate = new System.DateTime[]
                { startDate[0].AddDays(2), startDate[1].AddDays(2) };
            var description = new string[] 
                { title[0], title[1] };
            genCourses.Add(new Course
                { Name = title[0], StartDate = startDate[0], EndDate = endDate[0], Description = description[0] });
            genCourses.Add(new Course
                { Name = title[1], StartDate = startDate[1], EndDate = endDate[1], Description = description[1] });
            return genCourses;
        }
